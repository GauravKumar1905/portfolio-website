                ...
                >
                    <div className="flex items-center gap-3 mb-12 border-b border-zinc-800 pb-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-4xl md:text-5xl font-bold mb-2">Product Management Intern</h1>
                            <p className="text-xl text-gray-300 font-medium mb-2">Gaana, Times Group</p>
                    ...
                    <div className="space-y-12">
                        ...
                        <section>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {['Product Analytics', 'UX Optimization', 'A/B Testing', 'User Journey Mapping', 'Performance Metrics', 'SQL', 'Data Analysis'].map((tag, i) => (
                                    <span
                                        key={i}

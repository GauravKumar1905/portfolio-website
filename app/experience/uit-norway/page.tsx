                ...
                >
                    <div className="flex items-center gap-3 mb-12 border-b border-zinc-800 pb-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-4xl md:text-5xl font-bold mb-2">Research Intern</h1>
                            <p className="text-xl text-gray-300 font-medium mb-2">UiT – The Arctic University of Norway</p>

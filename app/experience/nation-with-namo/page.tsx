...
export default function NationWithNamoPage() {
    return (
                ...
                >
                    <div className="flex items-center gap-3 mb-12 border-b border-zinc-800 pb-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-4xl md:text-5xl font-bold mb-2">Associate Consultant</h1>
                            <p className="text-xl text-gray-300 font-medium mb-2">Nation with Namo</p>
                            <div className="flex items-center gap-2 text-gray-400">
                                <Calendar size={16} />
                                <span>Jul 2023 – May 2024</span>
                            </div>
                        </div>
                    </div>

...
export default function ChickFilAPage() {
    const images = [
        '/images/experience/chick-fil-a/automation-1.png',
        '/images/experience/chick-fil-a/automation-2.png',
        '/images/experience/chick-fil-a/automation-3.png',
        '/images/experience/chick-fil-a/automation-4.png',
    ];
